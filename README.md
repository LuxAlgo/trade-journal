...
| **Charts**               | A live Vela chart for any symbol from your market-data source, built for a stylus: the pen tip draws, the eraser end erases, fingers pan. Pine Script indicators (15 built-ins plus your own, written in the editor) run on PineTS. Analyses save automatically per symbol, with drawing layers in folders and alerts when price crosses your lines or an indicator signals; embed them in the daily journal as images that reopen the chart. See [docs/charts.md](docs/charts.md).                                                                        |
