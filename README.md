...
| **Charts**               | A standalone Vela chart for any symbol from your market-data source, built for a stylus: the pen tip draws, the eraser end erases, fingers pan. Save analyses with their drawings and embed them in the daily journal as images that reopen the chart. See [docs/charts.md](docs/charts.md).                                                                                                                                                                                                                                                               |
