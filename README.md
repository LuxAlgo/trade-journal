...
| **Charts**               | A live Vela chart for any symbol from your market-data source, built for a stylus: the pen tip draws, the eraser end erases, fingers pan. Analyses save automatically per symbol, with drawing layers in folders and alerts when price crosses your lines; embed them in the daily journal as images that reopen the chart. See [docs/charts.md](docs/charts.md).                                                                                                                                                                                          |
